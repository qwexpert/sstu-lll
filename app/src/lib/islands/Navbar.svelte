...
{#if page.url.pathname !== '/lab1' && isPC}
	...
	>
		<div class="grid h-full max-w-lg grid-cols-5 mx-auto">
			<button
				...
				type="button"
				class="inline-flex flex-col items-center justify-center px-5 rounded-s-full hover:bg-gray-50 dark:hover:bg-gray-800 group cursor-pointer duration-300"
			>
				<svg
			...
			<div class="flex items-center justify-center">
				<button
					...
					type="button"
					class="inline-flex items-center justify-center w-10 h-10 font-medium bg-blue-600 rounded-full hover:bg-blue-700 group cursor-pointer duration-300"
				>
					<svg
			...
			<button
				...
				type="button"
				class="inline-flex flex-col items-center justify-center px-5 rounded-e-full hover:bg-gray-50 dark:hover:bg-gray-800 group cursor-pointer duration-300"
			>
				<svg
					class="w-5 h-5 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500"
					aria-hidden="true"
